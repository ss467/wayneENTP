...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: fGhF70IXmgCS/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: zKLPNDAMDriC/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: sPkdR2m7t8Ha/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__ui8Ko)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
        ...
        __composite["0"]["path"] = `/`;
        __composite["0"]["name"] = "Orders";
        __composite["1"]["path"] = `/products`;
        __composite["1"]["name"] = "Products";
        __composite["2"]["path"] = `/categories`;
        __composite["2"]["name"] = "Categories";
        return __composite;
      })()}
      simpleNavTheme={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__cum5F)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___6G2H)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox___7ZzaX)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__oqpl9)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
